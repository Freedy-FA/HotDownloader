...
pub fn emit_progress(app_handle: &AppHandle, task_id: &str, downloaded: u64, total: u64, speed: u64) {
...
pub fn emit_completed(app_handle: &AppHandle, task_id: &str, final_path: &str) {
